...
\entry{Fr{\"u}hling 2016}{Freiwilliges Praktikum}{PT. Siemens Indonesia}{-- Dampfturbinenherstellung\vspace{-.25cm} 
	...
	\item Werker beim Bohren, Fr{\"a}sen und der Schaufelmontage unterst{\"u}tzt 
...
\begin{minipage}{0.19\textwidth}
	\centering
	\hspace{-50mm}\includegraphics[width=0.8\textwidth]{unterschrift}
\end{minipage}
\begin{minipage}{0.4\textwidth}
	\flushright
	\href{https://github.com/emfiedler/cv}{\textsc{sourcecode}}
\end{minipage}
